...
* **Model weight protection.** Protect proprietary model weights from exfiltration during inference, training, and fine-tuning. Weights never leave hardware-encrypted enclaves.
