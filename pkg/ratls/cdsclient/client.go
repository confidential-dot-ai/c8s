...
func NewClient(cfg *Config) *Client {
	...
	if httpClient == nil {
		policy := &ratls.VerifyPolicy{Policy: remote.Policy{Measurements: cfg.CDSMeasurements, RTMRs: cfg.CDSRTMRs, Images: cfg.CDSImagePins}, AttestationApiURL: cfg.AttestationApiURL}
