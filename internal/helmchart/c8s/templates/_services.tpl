...
{{- if or .Values.attestationApi.enabled .Values.node.bakedServices -}}
...
{{- if and (not .Values.attestationApi.enabled) (not .Values.node.bakedServices) (eq .Values.attestationApi.cvmMode "bare-metal") -}}
- name: HOST_IP
  valueFrom:
    fieldRef:
