...
// seedStore reads the JSON allowlist at path and seeds its digests and workload
// entries into store. It owns the file/wire-format concerns; the additive,
// version-stable merge is Store.SeedDigests.
//
