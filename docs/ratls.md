...
| `…1.3` | static allowlist — `staticallowlist.go`, see [docs/static-allowlist.md](static-allowlist.md) | CDS under `--static-allowlist`, on its own mesh CA certificate, next to a `…1.1` extension binding the CA key |
