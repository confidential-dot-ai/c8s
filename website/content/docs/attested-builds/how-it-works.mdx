---
title: "How Attested Builds Work"
description: "The architecture and mechanics of attested builds, phase by phase, from source to running code."
---
...
We assume you've read [What Are Attested Builds?](/docs/attested-builds/what-are-attested-builds) and understand the core concept: attested builds prove that specific inputs were used to produce specific outputs in a verified environment. This document shows exactly how that works.
