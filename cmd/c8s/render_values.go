...
func init() {
	...
	renderValuesCmd.Flags().StringVar(&installMinTCB, "min-tcb", "", "minimum SEV-SNP platform TCB as bootloader,tee,snp,microcode (e.g. 3,0,8,0). Emits minTcb; empty leaves the chart's shipped floor")
